...
class InAlgoTestCase(unittest.TestCase):
    ...
    def test_correct_random_forest_parameter_type(self):
    ...
    def test_correct_random_forest_parameter_none(self):
        # given: collect input parameter, create algorithm object
        arg_dict = {
            "max_depth": None,
            "n_estimators": 10,
    ...
    def test_error_random_forest_parameter_type(self):
         # given: error input parameter "max_depth" needs to be type(int)
        arg_dict = {
        	"max_depth": True,
            "n_estimators": 10,
            "n_jobs": 1
        ...
        algo_input = alc.AlgoParam(algo_control={'mode': 'training', 'control_params': arg_dict},
                                   algo_data={'data': self.iris_data, 'label': self.iris_label},
                                   algo_model={'model_params': None, 'model_instance': None})
        in_algo = AlgoUtils.algo_factory('random-forest')
        input_params_definition = in_algo.get_input_params_definition()
        # when: checkout input type
        check_result = in_algo.check_input_params(input_params_definition, algo_input.algo_control.control_params)
        # then: type match
    ...
    def test_error_random_forest_parameter_more(self):
         # given: error input parameter "max_depth" needs to be type(int)
        # given: collect input parameter, create algorithm object
        arg_dict = {
        	"max_depth": 1,
    ...
    def test_correct_random_forest_do_algo(self):
        # given: collect input parameter, create algorithm object
        arg_dict = {
        	"max_depth": 1,
            "n_estimators": 10,
        ...
        # when: do random forest algorithm
    ...
    def test_correct_random_forest_do_algo_none(self):
        # given: collect input parameter, create algorithm object
        arg_dict = {
            "max_depth": None,
            "n_estimators": 10,
    ...
    def test_error_random_forest_do_algo(self):
        # given: collect input parameter, create algorithm object
        arg_dict = {
            "max_depth": 10,
            "n_estimators": 10,
